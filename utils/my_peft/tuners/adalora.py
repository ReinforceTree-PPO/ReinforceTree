...
if is_bnb_available():
    try:
        ...
        print(f"Warning: bitsandbytes import failed in adalora: {e}")
        print("Continuing without 8-bit quantization support")
        bnb = None
else:
    bnb = None
        ...
        for key in key_list:
            ...
            if target_module_found:
                ...
                if isinstance(target, LoraLayer):
                    ...
                    if loaded_in_8bit and bnb is not None and isinstance(target, bnb.nn.Linear8bitLt):
                        kwargs.update(
                            {
...
if is_bnb_available() and bnb is not None:
